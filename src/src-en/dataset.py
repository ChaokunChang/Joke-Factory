        ...
        with open(data_path,'r',encoding='utf-8') as fin:
            ...
            for joke in jokes:
                if len(joke['body']) > 0:
                    ...
                    sample_num += 1
                    sample_len.append(len(joke['title'] + joke['body']))
    else:
            ...
            for joke in jokes:
                if joke['score'] >= 3:
                    if len(joke['body']) == 0:
                        ...
                        instance = Instance(raw_joke=joke['title'] + joke['body'])
...
if __name__ == "__main__":
    # get_joke_data('/home/ubuntu/nlp-project/JokeGenerator/data/qa_joke/reddit_jokes.json')
    # conf = Config()
    # data = JokeData(conf)
    ...
    # data.get_vocab()
    # import pickle
    # with open('/home/ubuntu/nlp-project/JokeGenerator/data/vocab/vocab10.pickle', 'wb') as fout:
    #     pickle.dump(data, fout)


    data_analysis('/home/ubuntu/nlp-project/JokeGenerator/data/qa_joke/reddit_jokes.json')